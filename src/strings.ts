const strings = {
  en: {
    ...
    regview: {
      ...
      register: 'Register',
      information_hint: 'The information collected will only be used for validating your identity and contacting you. Data will be kept safely on our server and will only be visible to management group of this association.',
      complete: 'Complete',
      submit: 'Submit',
      label: {
        name: 'Name',
    ...
    errorview: {
      ...
      internal_error_hint: 'Oops, we encounter an error, please try again later.',
      ...
      unknown_error_hint: 'Oops, we encounter an unknown error, please try again later.',
      back: 'Back to Home'
    },
    adminview: {
  ...
  zh: {
    ...
    regview: {
      ...
      tsinghua_git: 'Tsinghua Git',
      register: '注册',
      information_hint: '我们只会使用您提供的信息来验证您的身份和联系您。数据将会安全地存储在我们的服务器上，并且只有本协会的管理成员可以查看。',
      complete: '完成',
      submit: '提交',
      label: {
        name: '姓名',
    ...
    errorview: {
      ...
      session_not_found_hint: '您的请求使用了一个错误的会话。这通常可以通过重试来解决。',
      unauthorized: '未授权',
